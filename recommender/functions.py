...
import openai
import requests
openai.api_key = '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'
api_key = 'AIzaSyAIJHZ8_jFbJjTkQPvbvVGnF0AyF6nCysk'
cx_id = '55fc570564b7b40d6'
...
def chatfunction(question):
    ...
    print(f'Ans: {chat_response}')
    return  chat_response


def get_image(question):
    cont = question
    url = f'https://www.googleapis.com/customsearch/v1?q={cont}&cx={cx_id}&searchType=image&key={api_key}'
